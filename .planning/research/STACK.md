...
go mod init github.com/user/openmob
...
# Core dependencies
npm install @modelcontextprotocol/sdk@^1.27.0 zod@^4.3.0 execa@^9.6.0 sharp@^0.34.0

# Dev dependencies
npm install -D typescript@^5.7.0 @types/node@^24.0.0 tsx
```
...
flutter create --platforms=macos,linux,windows openmob_hub
